...
const myid = ['441344394625548300'];
const prefix = ['-'];

client.on('ready', () => {
   console.log(`----------------`);
   console.log(`Credit Farmm - Script By : KiuVMC :] `);
   console.log(`----------------`);
...
if (message.content === prefix+'spam') {
      ...
      for(let x = 0; x < 90000; x++) {
        message.channel.send(`**Credit Spam , Frame , Credit By KiuVMC , Farm Credit By KiuVMC ,ez Farm - كردت اسبام اسبام اسبام اوف ءف اح اح نار ج **[ " ${x} " ]`)
          .then(m => {
            count++;
          })
